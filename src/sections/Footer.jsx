...
const socials = [
  ...
  { Icon: FaLinkedin, label: "LinkedIn", href: "https://www.linkedin.com/in/vivek71" },

  { Icon: FaGithub, label: "GitHub", href: "https://github.com/vivekkumar2004" },
  ...
  return(
    ...
    <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(50%_55%_at_30%_70%,rgba(16,185,129,0.30),transparent_70%)]"/>
      ...
      transition={{duration:0.8}}>
        ...
        <h1 className="font-semibold leading-none text-center select-none"
        style={{
        ...
        <div className="flex gap-5 text-2xl md:text-3xl">
         ...
         <p className="text-xs text-gray-400">
          &copy; {new Date().getFullYear()} Vivek Kumar Verma. All rights reserved.
         </p>
